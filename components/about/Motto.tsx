...
export default function Motto() {
  return (
    <div className='size-full bg-linear-to-br from-portground/20 to-slate-900/40 backdrop-blur-sm rounded-3xl flex flex-col items-start p-8 border border-amber-500/20 relative overflow-hidden h-full min-h-100'>
        <svg xmlns="http://www.w3.org/2000/svg" className="size-8 text-portground/40 mb-auto" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-auto">
            <h3 className="text-white text-3xl md:text-4xl font-black leading-none tracking-tight">
                SOFTWARE <br /> 
                <span className="text-portground text-4xl md:text-5xl italic font-serif tracking-normal leading-tight">
                    Sin Límites.
                </span>
            </h3>
            
            <div className="h-1 w-12 bg-portground mt-5 mb-4 rounded-full shadow-[0_0_10px_rgba(245,158,11,0.5)]"></div>
