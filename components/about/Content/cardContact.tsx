...
export default function ContactCard() {
  ...
  return (
    <div ref={ref} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} data-active={isActive}
     ...
     bg-teal p-8 text-cream transition-all duration-700 data-[active=true]:border-mahogany/30 data-[active=true]:shadow-[0_0_40px_rgba(48,16,20,0.15)] md:p-9 " 
    >
      <div
        className=" pointer-events-none absolute inset-0 opacity-[0.13] "
        style={{
          backgroundImage:'radial-gradient(circle at 2px 2px, rgba(237,244,237,0.18) 1px, transparent 0)',
          backgroundSize: '24px 24px',
        }}
      />
      <svg className=" pointer-events-none absolute right-6 top-6 h-32 w-32 rotate-12 text-mahogany opacity-[0.10]
      ...
      <div className=" relative z-10 flex items-start justify-between ">
        <div className=" rounded-2xl border border-mahogany/15 bg-mahogany/10 p-3.5 text-mahogany backdrop-blur-md
        ...
        <div className=" flex items-center gap-2 rounded-full border border-mahogany/15 bg-mahogany/10 px-3 py-1.5 backdrop-blur-sm ">
          ...
          <span className=" font-mono text-[9px] font-bold uppercase tracking-widest text-mahogany/75 " >
            Disponible
          </span>
        </div>
      </div>
      <div className="relative z-10 mt-auto pt-8">
        <p className=" mb-3 font-mono text-xs uppercase tracking-[0.2em] text-mahogany/65 transition-colors duration-500 group-data-[active=true]:text-cream " >
          ¿Tienes un reto?
        </p>
        <h3 className=" font-heading text-4xl font-black leading-[0.9] tracking-[-0.04em] md:text-5xl ">
          Hablemos de
          <span className="block text-mahogany">
            tu proyecto.
          </span>
        </h3>
        <a href="#contacto" onClick={(e) => handleSmoothScroll(e, '#contacto')}
          className=" mt-8 flex w-full items-center justify-between rounded-2xl border border-mahogany/20
           px-6 py-4 font-bold text-cream transition-all duration-500 hover:border-mahogany/40 
           hover:bg-mahogany/10 active:scale-[0.98] group-data-[active=true]:border-mahogany/30 "
        >
