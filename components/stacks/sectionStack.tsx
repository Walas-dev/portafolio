...
export default function sectionStack({ title, colorTitle, fondo, children }: Content) {
    return (
        <div className={`SECCION-STACK flex flex-col md:w-[98%]  rounded-3xl border-slate-700 transition-all border px-3 py-5 md:px-6 md:py-15 gap-3 md:flex-row items-center justify-around ${fondo}`}>
