    ...
    <div className='size-full bg-linear-to-br from-[#FD105E]/20 to-slate-900/40 backdrop-blur-sm rounded-3xl flex flex-col items-start p-8 border border-amber-500/20 relative overflow-hidden h-full'>
        ...
        <div className="mt-auto">
            <h3 className="text-white text-3xl md:text-4xl font-black leading-none tracking-tight">
                SOFTWARE <br /> 
                <span className="text-[#FD105E] text-4xl md:text-5xl italic font-serif tracking-normal leading-tight">
                    Sin Límites.
                </span>
            </h3>
            
            <div className="h-1 w-12 bg-[#FD105E] mt-5 mb-4 rounded-full shadow-[0_0_10px_rgba(245,158,11,0.5)]"></div>
