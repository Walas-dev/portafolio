...
export default function contactCard() {
  return (
    <div className='flex flex-col gap-3 items-center justify-center text-center bg-slate-900 rounded-3xl  p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] border border-amber-500/30 relative overflow-hidden'>
        <h4 className=''>
